...
function sendOtp() {
    ...
    fetch(`${BASE}/api/mechanic/forgot-password/find-user`, {
        method: "POST",
        headers: {
...
function verifyOtp() {
    ...
    fetch(`${BASE}/api/mechanic/forgot-password/verify-otp`, {
        method: "POST",
        headers: {
            "Content-Type": "application/json"
        },
...
function resetPassword() {
    ...
    // ✅ Call backend API
    fetch(`${BASE}/api/mechanic/forgot-password/reset-password`, {
        method: "POST",
        headers: {
            "Content-Type": "application/json"
        },
